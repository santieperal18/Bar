      ...
      <div className="login-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="login-field">
            ...
            <input id="usuario" type="text" value={usuario} onChange={(e) => setUsuario(e.target.value)} placeholder="Ingresá tu usuario" disabled={cargando} autoFocus autoComplete="username" />
          </div>
          ...
          <button type="submit" className="login-btn" disabled={cargando || !usuario || !contrasena}>
